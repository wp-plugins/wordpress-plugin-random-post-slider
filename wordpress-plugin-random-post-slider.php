...
function gopiplushome() 
{
	...
	?>
	<!-- begin gopiplushome -->
    <script type="text/javascript" src="<?php echo get_option('siteurl'); ?>/wp-content/plugins/wordpress-plugin-random-post-slider/js/jquery-1.3.2.min.js"></script>
	<script type="text/javascript" src="<?php echo get_option('siteurl'); ?>/wp-content/plugins/wordpress-plugin-random-post-slider/js/jquery.cycle.all.min.js"></script>
    <link rel="stylesheet" type="text/css" href="<?php echo get_option('siteurl'); ?>/wp-content/plugins/wordpress-plugin-random-post-slider/wordpress-plugin-random-post-slider.css" />
	<div id="gopiplushome">
	<?php
...
function gopiplus_admin_options() 
{
	echo "<div class='wrap'>";
	echo "<h2>"; 
	echo wp_specialchars( "Random post slider" ) ;
	echo "</h2>";
	...
	echo '</div>';
	?>
	<h2>Plugin configurationt</h2>
    <ul>
    <li><a href="http://www.gopiplus.com/work/2011/05/28/wordpress-plugin-random-post-slider/" target="_blank">Add directly in the theme</a></li>
...
//	if(@$qp_category <> ""){ @$myfilter = @$myfilter."&cat=".$qp_category; }
	...
	$gopiplushome = $gopiplushome . "<script type='text/javascript' src='".get_option('siteurl')."/wp-content/plugins/wordpress-plugin-random-post-slider/js/jquery-1.3.2.min.js'></script>";
	$gopiplushome = $gopiplushome . "<script type='text/javascript' src='".get_option('siteurl')."/wp-content/plugins/wordpress-plugin-random-post-slider/js/jquery.cycle.all.min.js'></script>";
	$gopiplushome = $gopiplushome . "<link rel='stylesheet' type='text/css' href='".get_option('siteurl')."/wp-content/plugins/wordpress-plugin-random-post-slider/wordpress-plugin-random-post-slider.css' />";
