...
function gopiplus_admin_options() 
{
    ...
    <li>Check official website for live demo <a href="http://www.gopiplus.com/work/2011/07/24/wordpress-plugin-wp-iframe-images-gallery/" target="_blank">click here</a></li>
    </ul>
    <?php
}
